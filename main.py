...
if __name__ == '__main__':
    ...
    UniqueWordDataFrame = ComputeTermFrequency(NewsData['text'], words_set)
    ...
    # Csv File Contain All TF For Unique Word
    UniqueWordDataFrame.to_csv("Calculate-TF.csv", encoding='utf-8', header=True, index=False)
